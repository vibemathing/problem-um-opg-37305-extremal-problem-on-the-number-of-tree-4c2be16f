...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-opg-37305-extremal-problem-on-the-number-of-tree-4c2be16f-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/OPG-37305"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-opg-37305-extremal-problem-on-the-number-of-tree-4c2be16f-v1",
      "problem_contract_sha256": "d5fb95db78f1f79e50696f2ea9c18bf187dc5351252af13d1d8c235ae14778fe",
      "problem_id": "problem:um-opg-37305-extremal-problem-on-the-number-of-tree-4c2be16f",
      "route_id": "route:um-opg-37305-extremal-problem-on-the-number-of-tree-4c2be16f-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-opg-37305-extremal-problem-on-the-number-of-tree-4c2be16f-source-fidelity-01",
      "graph_id": "graph:um-opg-37305-extremal-problem-on-the-number-of-tree-4c2be16f-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-opg-37305-extremal-problem-on-the-number-of-tree-4c2be16f-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-opg-37305-extremal-problem-on-the-number-of-tree-4c2be16f-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Conjecture An endomorphism of a graph is a mapping on the vertex set of the graph which preserves edges. Among all the $n$ vertices' trees, the star with $n$ vertices has the most endomorphisms, while the path with $n$ vertices has the least endomorphisms."
          },
          "statement_sha256": "410c346fad3ab4f4aad065e119c2b98f7e53c5d19be5cd456ee8b566c6ffed58"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-opg-37305-extremal-problem-on-the-number-of-tree-4c2be16f-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-opg-37305-extremal-problem-on-the-number-of-tree-4c2be16f-root",
      "route_id": "route:um-opg-37305-extremal-problem-on-the-number-of-tree-4c2be16f-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-opg-37305-e6380c81d2b9",
        "url": "https://www.unsolvedmath.com/problems/OPG-37305"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
